...
class TestCpn2022PreEENanoV12Integration:
    ...
    def test_data_available(self):
        ...
        for dataset_name in [
            ...
            dataset_inst = cpn_2022_pre_ee_nano_v12.get_dataset(
                dataset_name, None
            )
    ...
    def test_signal_available(self):
        ...
        # expected attributes
        dataset_inst = cpn_2022_pre_ee_nano_v12.get_dataset(
            "xyh_{y_decay_mode}_{h_decay_mode}_mx{m_x}_my{m_y}_madgraph", None
        )
...
class TestCpn2022PostEENanoV12Integration:
    ...
    def test_data_available(self):
        ...
        for dataset_name in [
            ...
            dataset_inst = cpn_2022_post_ee_nano_v12.get_dataset(
                dataset_name, None
            )
...
class TestCpn2023PreBPixNanoV12Integration:
    ...
    def test_data_available(self):
        ...
        for dataset_name in [
            ...
            dataset_inst = cpn_2023_pre_bpix_nano_v12.get_dataset(
                dataset_name, None
            )
...
class TestCpn2023PostBPixNanoV12Integration:
    ...
    def test_data_available(self):
        ...
        for dataset_name in [
            ...
            dataset_inst = cpn_2023_post_bpix_nano_v12.get_dataset(
                dataset_name, None
            )
...
class TestCpn2024NanoV15Integration:
    ...
    def test_signal_available(self):
        ...
        # Verify the data samples have been added and that they have the
        # expected attributes
        dataset_inst = cpn_2024_nano_v15.get_dataset(
            "xyh_{y_decay_mode}_{h_decay_mode}_mx{m_x}_my{m_y}_madgraph", None
        )
...
class TestCpn2025NanoV15Integration:
    ...
    def test_signal_available(self):
        ...
        # Verify the data samples have been added and that they have the
        # expected attributes
        dataset_inst = cpn_2025_nano_v15.get_dataset(
            "xyh_{y_decay_mode}_{h_decay_mode}_mx{m_x}_my{m_y}_madgraph", None
        )
