...
dataset_nicks = {
    ...
    **{
        ...
        not in get_profile().missing_signal_samples[cpn_2024_nano_v15.name]
    },
    ...
    # --- W + jets production --------------------------------------------------
    "w_enu_amcatnlo": "WtoENu-2Jets_TuneCP5_13p6TeV_amcatnloFXFX-pythia8_RunIII2024Summer24NanoAODv15-150X",
    "w_munu_amcatnlo": "WtoMuNu-2Jets_TuneCP5_13p6TeV_amcatnloFXFX-pythia8_RunIII2024Summer24NanoAODv15-150X",
    "w_taunu_amcatnlo": "WtoTauNu-2Jets_TuneCP5_13p6TeV_amcatnloFXFX-pythia8_RunIII2024Summer24NanoAODv15-150X",
    # --- Diboson production ---------------------------------------------------
